                        ...
                        @foreach($data as $value)
                            <div class="d-flex align-items-center pb-4 check_div">
                                <div class="avatar-md me-4">
                                    <img
                                        src="{{ !empty($value['goods_icon']) ? URL::asset($value['goods_icon']) : URl::asset('h5/icon/juan.png') }}"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @if(!empty(floatval($value['goods_price'])))
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="form-group">
                        <input id="chargeAccount" class="input-material" type="number" maxlength="11"
                               name="charge_account"
                               placeholder="请输入手机号" value="{{ $mobile ?? '' }}">
