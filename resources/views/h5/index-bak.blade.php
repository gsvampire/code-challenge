...
<div class="page login-page">
    <div class="container align-items-center">
                    ...
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <button id="regbtn" type="button" name="registerSubmit" class="btn btn-primary regbtn">
                                    确认兑换
                                </button>
                            </div>
        ...
        <footer class="main-footer pt-1"
                style="position: static;background: rgba(251,251,251,0.6);text-align: center;bottom: -100px;">
